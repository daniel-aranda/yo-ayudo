...
async function upsert_yoayudo_commercial_operator_bot(pool, input) {
  ...
  const interactions = [
    ...
    },
    {
      ...
      instructions: "Cuando reporten ventas, regístralas y desglosa efectivo, tarjeta, transferencia y apps si lo mencionan.",
    },
    {
      ...
      instructions: "Cuando reporten una compra de insumos, captura artículo, cantidad, costo y proveedor.",
    },
    {
      ...
      instructions: "Cuando reporten el cierre, registra totales y efectivo en caja, y genera el resumen del día.",
    },
    {
      ...
      instructions: "Cuando reporten un conteo de inventario, captura los artículos con su cantidad y unidad.",
    },
    {
      ...
      instructions: "Captura notas operativas del día: merma, faltante, sobrante o comentario libre.",
    },
    {
      ...
      instructions: "Cuando pidan el reporte del día, genéralo con totales, métricas y alertas.",
    },
  ];
  const bot = await upsert_bot_record(pool, {
    organization_id: input.organization_id,
