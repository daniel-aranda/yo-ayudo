...
const env_schema = z.object({
  ...
  CONVERSATION_MEDIA_S3_BUCKET: z.string().default(""),
  CONVERSATION_MEDIA_S3_PREFIX: z.string().default("yoayudo/conversation-media"),
  CONVERSATION_MEDIA_LOCAL_DIR: z.string().default(".storage/conversation-media"),
  CONVERSATION_MEDIA_MAX_BYTES: z.coerce.number().int().positive().default(25 * 1024 * 1024),
...
export const config = {
  ...
  // Instagram DM y Messenger comparten la app de Meta: el verify token y el app
  // secret caen a los de WhatsApp si no se definen aparte (un solo Meta app).
  meta_verify_token: parsed_env.META_VERIFY_TOKEN || parsed_env.WHATSAPP_VERIFY_TOKEN,
  meta_app_secret: parsed_env.META_APP_SECRET || parsed_env.WHATSAPP_APP_SECRET,
  ...
  conversation_media_s3_bucket: parsed_env.CONVERSATION_MEDIA_S3_BUCKET,
  conversation_media_s3_prefix: parsed_env.CONVERSATION_MEDIA_S3_PREFIX,
  conversation_media_local_dir: parsed_env.CONVERSATION_MEDIA_LOCAL_DIR,
  conversation_media_max_bytes: parsed_env.CONVERSATION_MEDIA_MAX_BYTES,
